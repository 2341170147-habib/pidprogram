...
// Firebase
#define FIREBASE_HOST "https://chiller-alarm-organon-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "53tqUFNtdcyEN6IG3QxoYhxOMDd9R69ucKmDaw2o"
...
void handleWiFiDisconnect() {
  ...
  if (firebase_ready) {
    sendWiFiStatusAlert("DISCONNECTED");
  }
}
...
void displayAlarmStatus() {
  ...
  tft.setCursor(5, 52);
  tft.printf("Firebase: %s", firebase_ready ? "RDY" : "INIT");
